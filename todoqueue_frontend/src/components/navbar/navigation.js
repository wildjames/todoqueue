        ...
        <div>
            <Navbar className="navbar" bg="dark" variant="dark" sticky="left">
                ...
                <Nav className="me-right">
                    {!isAuth && <Nav.Link href="/signup" style={{ paddingLeft: '2vw', paddingRight: '2wv' }}>Sign Up</Nav.Link>}
                    {isAuth ?
                        <Nav.Link href="/logout" style={{ paddingLeft: '2vw', paddingRight: '2wv' }}>Logout</Nav.Link> :
                        <Nav.Link href="/login" style={{ paddingLeft: '2vw', paddingRight: '2wv' }}>Login</Nav.Link>
                    }
                </Nav>
            </Navbar>
        </div>
